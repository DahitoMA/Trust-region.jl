# The trust-region method using a truncated version of MINRES to find the steps.
# TRminres(model,Δ,ϵa,ϵr,itemax,verbose) solves a continous optimisation problem 'model' within
# a trust region and with tolerances ϵa and ϵr.

"""The trust-region method using truncated MINRES.
"""
function TRminres(model, Δ::Float64=10., ϵa::Float64=1e-6, ϵr::Float64=1e-6, itemax::Int=10000, verbose::Bool=false)
    ...
    jldname = "resultMINRES.jld"
    txtname = "resultMINRES.txt"
