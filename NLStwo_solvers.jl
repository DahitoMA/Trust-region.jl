...
p = performance_profile(hcat([p[2:end, 1] for p in values(stats)]...),
                            ...
                            titlefont = tf, legendfont = f, guidefont = f) # Profile for #r
...
#                             titlefont = tf, legendfont = f, guidefont = f) # Profile for #Av
#
...
#                             titlefont = tf, legendfont = f, guidefont = f) # Profile for #A'v
#
...
#                             titlefont = tf, legendfont = f, guidefont = f) # Profile for #r + #Av + #A'v
#
